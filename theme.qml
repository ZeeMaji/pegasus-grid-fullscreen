...
import "layer_filter"
// Maji Change - Don't load game info layer
...
FocusScope {
    Keys.onPressed: {
        ...
        if (api.keys.isDetails(event)) {
            event.accepted = true;
            //gamepreview.focus = true; // Maji Change - Don't do this idk just to be safe
            return;
        }
    ...
    GameGrid {
        ...
        // onDetailsRequested: launchGame()  // Maji Change - Don't need this.
        onLaunchRequested: launchGame()
    }
// Maji Change - Don't load game preview layer.
/*
    GamePreview {
        id: gamepreview
